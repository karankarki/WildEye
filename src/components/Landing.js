          ...
          <header className="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
            ...
            <div className="container-fluid">
              <div className="d-flex align-items-center">
                <div className="site-logo"><img src={process.env.PUBLIC_URL +"/imgs/Logo.png"} alt="WildSphere-Logo" height="50" width="50"/></div>
                <h5>&nbsp;Smart Wildlife Monitoring</h5>
                <div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-5 mr-auto" data-aos="fade-up">
                  <div className="owl-carousel slide-one-item-alt-text">
                    ...
                    <div className="slide-text">
                      <h1>Smart Wildlife Monitoring</h1>
                      <p className="mb-5">Smart Wildlife Monitoring is a system that utilizes the YOLOv8n (You Only Look Once) algorithm for object detection to protect and safeguard wildlife. YOLO is a real-time object detection algorithm that can quickly and accurately detect objects of interest in images or video frames.</p>
                ...
                <div className="col-lg-6 ml-auto"  data-aos="fade-up" data-aos-delay="100">
                  ...
                  <div className="owl-carousel slide-one-item-alt">
                    <img src={process.env.PUBLIC_URL +"/imgs/slide1.png"} alt="WildSphere" className="img-fluid"/>
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-5 mr-auto mb-5">
                  <img src={process.env.PUBLIC_URL +"/imgs/Identification.png"} alt="WildSphere" className="img-fluid"/>
                </div>
                
                <div className="col-lg-5 mr-auto mb-5"  data-aos="fade-up">
                  <div className="mb-5">
                    <h2 className="section-title">Smart Wildlife Monitoring</h2>
                    <p className="black-text">Smart Wildlife Monitoring is a wildlife species identification and offence registration web app.<br/>In the WildSphere system, images captured by cameras or other devices are passed as input to the YOLO algorithm for object detection and recognition. By feeding the images through the trained YOLO model, WildSphere can identify and localize wildlife species present in the images.</p>
              ...
              <div className="row">
                ...
                <div className="col-md-3 ml-auto">
                  ...
                  <ul className="list-unstyled footer-links">
                    ...
                    <li><a href="https://github.com/karankarki" className="smoothscroll">Github</a></li>
                  </ul>
                </div>

                <div className="col-md-4">
                  <h3>Project</h3>
                  <p>This is a project we made as a part of our SEM 3 curriculum.</p>
                </div>
